...
class Synchronizer {
  ...
  googleDrive () {
    ...
    return new Promise((resolve, reject) => {
      const driveFolderName = `tridev-${this.classification.package}-${this.classification.module}`
      ...
      waterfall([
          ...
          if (folderExists === false) {
            ...
            drive.files.create({
              ...
              return drive.permissions.create({
                ...
                emailMessage: 'Hey, I created a new folder to wrap your new content, cheers. tridev.',
        ...
        (folderId, cb) => {
          ...
          // Browse entities in tridev's memory
