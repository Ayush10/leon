...
const config = {
  app: 'webapp',
  server_host: import.meta.env.VITE_tridev_HOST,
  server_port: import.meta.env.VITE_tridev_PORT,
  min_decibels: -40, // Noise detection sensitivity
  max_blank_time: 1000 // Maximum time to consider a blank (ms)
}
const serverUrl = import.meta.env.VITE_tridev_NODE_ENV === 'production' ? '' : `${config.server_host}:${config.server_port}`
